...
export default {
  ...
  'menu.trans': '账务管理',
  'menu.trans.order-pay': '交易明细',
  'menu.trans.return': '退款',
  'menu.trans.settle': '对账汇总',
  'menu.trans.relation': '对账分析',
  'menu.trans.order': '订单',
  'menu.chart': 'Dashboard',
  'menu.chart.dashboard': '分析',
  'menu.basic': '数据管理',
  'menu.basic.merchant': '商户管理',
  'menu.basic.merchant-acc': '商户账户',
  'menu.basic.order-type': '订单类型',
  'menu.basic.channel-type': '渠道类型',
  'menu.basic.third': '第三方信息',
  'menu.basic.pay-type': '支付类型',
  'menu.basic.third-return': '第三方响应码',
  'menu.basic.third-state': '第三方交易状态',
  'menu.basic.trans-type': '交易类型',
  'menu.basic.error-code': '错误代码',
  'menu.basic.casher': '收费员',
  'menu.basic.industry': '行业',
