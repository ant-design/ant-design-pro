...
export default {
  ...
  'component.activeChart.target-assessment': '目标评估',
  'component.activeChart.expected-to-reach': '有望达到预期',
  'component.activeChart.billion': '{number} 亿元',
  'component.gauge.low': '差',
  'component.gauge.medium': '中',
  'component.gauge.good': '良',
  'component.gauge.great': '优',
  'menu.home': '首页',
