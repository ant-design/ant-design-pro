export default {
  ...
  'app.settings.menuMap.binding': 'Pengikatan Akun', // 'app.settings.menuMap.binding': 'Account Binding',
  ...
  'app.settings.security.phone-description': 'Mengikat Ponsel', //'app.settings.security.phone-description': 'Bound phone',
  ...
  'app.settings.security.email-description': 'Mengikat Email', //'app.settings.security.email-description': 'Bound Email',
  ...
  'app.settings.security.set': 'Setel', //'app.settings.security.set': 'Set',
  'app.settings.security.bind': 'Ikat', //'app.settings.security.bind': 'Bind',
  ...
  'app.settings.notification.messages-description':
    'Pesan dari Sistem akan diberitahu dalam bentuk surat',
  // 'app.settings.notification.messages-description':
