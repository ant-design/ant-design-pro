export default {
  ...
  'menu.list': 'Daftar',
  'menu.list.table-list': 'Mencari Tabel',
  ...
  'menu.account.trigger': 'Mengaktivasi Error', // 'menu.account.trigger': 'Trigger Error',
  'menu.account.logout': 'Keluar',
  'menu.editor': 'Penyusun Grafis',
  'menu.editor.flow': 'Penyusun Alur',
  'menu.editor.mind': 'Penyusun Mind', // 'menu.editor.mind': 'Mind Editor',
