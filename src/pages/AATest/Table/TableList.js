...
export default class TableList extends PureComponent {
  getColumns = table => {
    ...
    return [
      ...
      // to update: value翻译成key
      {
        ...
        // ],
        render(val) {
          return <span>{T_TESTKV ? T_TESTKV.kv[val] : ''}</span>;
  ...
  componentDidMount() {
    console.log(moment('20180801').format('YYYY-MM-DD'));
    console.log(moment('112201').format('YYYY-MM-DD HH:mm:ss'));
  ...
  //       desc: fields.desc,
  //       key: fields.key,
  //       tradeCode: 'ttest.updateByPrimaryKeySelective',
  //     },
  //   });
