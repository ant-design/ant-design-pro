...
const CreateForm = Form.create()(props => {
  ...
  const { fThirdid, f3code, fDisc, fReason, fResolve, fCode } = record;
  ...
  return (
    ...
    >
      ...
      <FormItem labelCol={{ span: 5 }} wrapperCol={{ span: 15 }} label="响应代码">
        {form.getFieldDecorator('f3code', {
          initialValue: f3code,
          rules: [
      ...
      <FormItem labelCol={{ span: 5 }} wrapperCol={{ span: 15 }} label="错误原因">
      ...
      <FormItem labelCol={{ span: 5 }} wrapperCol={{ span: 15 }} label="解决方法">
...
export default class TableList extends PureComponent {
  getColumns = table => {
    // to update: 列名
    const { T_THIRD, T_ERROR_CODE } = table;
    return [
      {
        dataIndex: 'fThirdid',
        title: '第三方代码',
  ...
  render() {
    ...
    return (
      <PageHeaderLayout title="查询表格">
        ...
        <CreateForm
          // to update: 中文翻译
          T_ERROR_CODE={table.T_ERROR_CODE}
