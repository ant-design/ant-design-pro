...
const CreateForm = Form.create()(props => {
  ...
  return ( <
    Modal destroyOnClose title = {
      (addOrUpdate === 1 && '新建') || (addOrUpdate === 2 && '更新')
    }
    visible = {
      modalVisible
    }
...
class UpdateForm extends PureComponent {
  ...
  renderContent = (currentStep, formVals) => {
    ...
    if (currentStep === 1) {
      return [ <
        FormItem key = "target" { ...this.formLayout
        }
        label = "监控对象" > {
        ...
        /FormItem>, <
        FormItem key = "template" { ...this.formLayout
        }
        label = "规则模板" > {
        ...
        /FormItem>, <
        FormItem key = "type" { ...this.formLayout
        }
        label = "规则类型" > {
    ...
    if (currentStep === 2) {
      return [ <
        FormItem key = "time" { ...this.formLayout
        }
        label = "开始时间" > {
        ...
        /FormItem>, <
        FormItem key = "frequency" { ...this.formLayout
        }
        label = "调度周期" > {
    ...
    return [ <
      ...
      /FormItem>, <
      FormItem key = "desc" { ...this.formLayout
      }
      label = "规则描述" > {
    ...
    return [{
      ...
      },
      {
        ...
        render: (text, record) => ( <
          ...
          <
          a onClick = {
            () => this.handleModalUpdate(true, record)
          } > 更新 < /a>
          ...
          onConfirm = {
            this.handleDelete.bind(null, record)
          } >
          <
          a href = "" > 删除 < /a> <
          /Popconfirm> <
