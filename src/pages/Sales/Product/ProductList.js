...
@connect(({ saleProduct, loading }) => ({
  product:saleProduct,
  loading: loading.models.saleProduct,
}))
@Form.create()
class ProductList extends PureComponent {
  ...
  columns = [
    
    {
      title: 'Tên Sản Phẩm',
      dataIndex: 'name',
      render: (text,row) => <a onClick={() => this.previewItem(row.id)}>{text}</a>,
    },
