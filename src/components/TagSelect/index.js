...
class TagSelect extends Component {
  ...
  render() {
    ...
    const expandText = get(actionsText, 'expandText', 'Expand');
    const collapseText = get(actionsText, 'collapseText', 'Collapse');
    const selectAllText = get(actionsText, 'selectAllText', 'All');
